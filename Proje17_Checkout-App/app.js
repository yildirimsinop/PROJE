...
// document.querySelector(".fa-regular.fa-trash-can").onmouseover = function () {
//     document.querySelector(".fa-regular.fa-trash-can").style.color="black"
// }
// document.querySelector(".fa-regular.fa-trash-can").onmouseout = function () {
//     document.querySelector(".fa-regular.fa-trash-can").style.color="red"}
